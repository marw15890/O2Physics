...
struct HFCandidateCreatorXicctoLcPiKPi{
  Produces<aod::HfCandXicc4> rowCandidateBase;
    ...
    for (auto& lcCand : lcCands) {
      ...
      for (const auto& rowTrackIndexProng3 : rowsTrackIndexProng3) {
        ...
        rowCandidateBase(collision.globalIndex(),
                         ...
                         lcCand.globalIndex(), track0.globalIndex(),
                         hfFlag);
...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  WorkflowSpec workflow{
    ...
    adaptAnalysisTask<HFCandidateCreatorXicctoLcPiKPi>(cfgc, TaskName{"hf-cand-creator-XicctoLCPiKPi"}),
